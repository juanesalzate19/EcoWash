    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                &nbsp;&nbsp;
                <input style="border:none;" type="text" value="<?php echo $row['usuario']; ?>">
            </div>
        </nav>
    <br><br><br><br><br>
<?php 
...
<div class="container">
 ...
 <?php    
        $resultados = mysqli_query($conexion,"SELECT *,cliente.documento,citas.direccion FROM citas,cliente,empleado WHERE citas.documento=cliente.documento AND citas.c_empleado=empleado.codigo AND citas.documento='$doc' AND title='realizado' ");
