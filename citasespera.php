...
<div class="container">
 ...
 <?php    
        $resultados = mysqli_query($conexion,"SELECT *,cliente.documento,citas.direccion FROM citas,cliente,empleado WHERE citas.documento=cliente.documento AND citas.c_empleado=empleado.codigo AND citas.documento='$doc' AND title='espera' ");
        ...
        <td><a href="cancelarcita.php?start='.$consulta['start'].'" onclick="return confirmar();"><button type="button" class="btn btn-outline-danger">&nbsp;&nbsp;&nbsp;&nbsp;X&nbsp;&nbsp;&nbsp;&nbsp;</button></a></td>
          </tr>
        ';
