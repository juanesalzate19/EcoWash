...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="citasagendadas.php?documento=<?php echo $doc; ?>" class="active">
                    <i class='bx bx-been-here'></i>
                    <span class="links_name">Citas Agendadas</span>
                </a>
            </li>
            <li>
                <a href="citasrealizadas.php?documento=<?php echo $doc; ?>">
                    <i class='bx bx-user'></i>
                    <span class="links_name" > citas realizadas  </span>
                </a>
            </li>
            <li>
                <a href="citasespera.php?documento=<?php echo $doc; ?>">
                    <i class='bx bx-user'></i>
                    <span class="links_name" > citas en espera  </span>
                </a>
            </li>
            <li>
                <a href="citascanceladas.php?documento=<?php echo $doc; ?>">
                    <i class='bx bx-user'></i>
                    <span class="links_name" > citas cancelado  </span>
                </a>
            </li>
            <li class="log_out">
                <a href="index.php">
    ...
    <section class="home-section">
        <nav>
            ...
            <div class="search-box">
                <input type="text" placeholder="Buscar... Por fecha" id="buscador_usuario" onkeypress="mi_busqueda();">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <div id="mostrar_mensaje">
                        ...
                        <?php    
                            $resultados = mysqli_query($conexion,"SELECT *,cliente.documento,citas.direccion FROM citas,cliente,empleado WHERE citas.documento=cliente.documento AND citas.c_empleado=empleado.codigo AND citas.documento='$doc'  ");
